...
- [x] `015-git-status-reader.md` — GitStatusReader: branch, ahead/behind, staged/unstaged/untracked, isDirty, poll mode
- [x] `016-git-commit-manager.md` — GitCommitManager: stage, commit (conventional format), amend, identity validation
- [x] `017-git-branch-manager.md` — GitBranchManager: create/switch/delete, detectDefaultBranch, push/pull
...
- [x] `018-workspace-detail-view.md` — 4-panel layout: git status, identity, AIDF tasks, quick actions. Real-time event updates.
- [x] `019-workspace-navigation.md` — Wire sidebar → WorkspaceDetail, breadcrumb, state management, keyboard routing
...
- [x] `020-provider-interface.md` — ProviderAdapter interface, ProviderRegistry, extend config schema
- [x] `021-claude-adapter.md` — ClaudeAdapter with @anthropic-ai/sdk, streaming, tool use
- [x] `022-openai-adapter.md` — OpenAIAdapter with openai SDK, validates abstraction works
...
- [x] `023-execution-engine.md` — ExecutionEngine: build prompt from AIDF, stream AI response, emit events
- [x] `024-action-parser.md` — ActionParser: extract file edits, shell commands, git ops from AI output
- [x] `025-execution-session.md` — ExecutionSession: multi-turn, history, action tracking, persistence
...
- [x] `026-approval-engine.md` — ApprovalEngine: queue actions, approve/reject/edit, events
- [x] `027-diff-review-view.md` — DiffReviewView: unified diff, risk badges, y/n/e/a keyboard
- [x] `028-action-executor.md` — ActionExecutor: execute approved actions, sandbox, rollback
...
- [x] Git status, commit, push, branch all work from TUI
- [x] Workspace detail shows live git status + identity + tasks
- [x] AI executes AIDF tasks with streaming output
- [x] All proposed changes shown as diffs for review
- [x] Approve/reject/edit workflow works end-to-end
- [x] Rollback restores files after undo
- [x] At least Claude and OpenAI providers supported
- [x] All tests pass
